...
The bar chart relies on size (i.e. length of the bar) for encoding therefore the color is uniform. Funding is expressed via vertical position. The bars are aligned on the x-axis to provide a uniform starting point improving length/area judgments. They are also ordered highest to lowest and separated along the x-axis.
...
The visualization provides the following three options for manipulation or change via drop-down lists:
